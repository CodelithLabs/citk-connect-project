      ...
      <div className="max-w-md w-full mx-auto">
        <div className="bg-surface-dark shadow-lg rounded-lg p-8 m-4">
          <div className="text-center mb-8">
            ...
            <h2 className="mt-4 text-2xl font-extrabold">Find your email</h2>
          </div>

          <form className="space-y-6">
            <div>
              <label htmlFor="phone" className="sr-only">Phone number or recovery email</label>
              <input id="phone" name="phone" type="text" autoComplete="tel" required className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-700 bg-bg-dark placeholder-gray-500 text-on-background focus:outline-none focus:ring-g-blue focus:border-g-blue focus:z-10 sm:text-sm" placeholder="Phone number or recovery email" />
            </div>
